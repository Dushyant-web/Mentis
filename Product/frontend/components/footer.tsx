    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-6 lg:px-12 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <span
                className="font-bold text-2xl tracking-tight text-background"
            ...
            <p className="text-background/70 mb-6 max-w-xs">
              Early dyslexia screening for better learning outcomes. 
        ...
        <div className="border-t border-background/10 pt-12 mb-12">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-xl font-bold text-background mb-3">
              Stay updated with MENTIS
            </h3>
            <p className="text-background/60 mb-6">
              Get the latest research, tips for parents, and product updates.
            </p>
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-5 py-3 rounded-full bg-background/10 border border-background/20 text-background placeholder:text-background/40 focus:outline-none focus:border-primary"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-background/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-background/50">
          <p>&copy; {new Date().getFullYear()} MENTIS. All rights reserved.</p>
